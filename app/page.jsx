      ...
      <div className="grid min-[832px]:grid-cols-2 w-full p-5 pt-44 min-[576px]:p-20">
        ...
        <div className="socials hidden mt-24">
          ...
          <div className="flex items-center flex-wrap gap-10 mt-3">
            ...
            <a href="https://open.spotify.com/user/pv9pjx6ygw9p7z1tz1yhtz2ar?si=e28fd7b755a14265" target="_blank" className="flex items-center w-36 h-14 pl-3 bg-[#F8F8F9] rounded-lg">
              <svg className="mt-3.5" width="38" height="38" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="w-full flex justify-center">SPOTIFY</p>
            </a>
          </div>
        </div>
